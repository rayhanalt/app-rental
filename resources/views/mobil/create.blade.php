...
@section('content')
    <div class="overflow-x-auto">
        <div class="card shadow-xl">
            <h3 class="sticky top-0 text-lg font-bold">Tambah Data Mobil
                <hr>
            </h3>
            <div class="card-body">
                <form action="/mobil" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="nopol" type="text" placeholder="Type here" value="{{ old('nopol') }}"
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="merk" type="text" placeholder="Type here" value="{{ old('merk') }}"
                            class="input-bordered input w-full max-w-full" />
                        <label class="label">
                            <span class="label-text-alt"></span>
                            <span class="label-text-alt text-red-600">
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="model" type="text" placeholder="click here" value="{{ old('model') }}"
                            class="input-bordered input w-full max-w-full" />
                        <label class="label">
                            <span class="label-text-alt"></span>
                            <span class="label-text-alt text-red-600">
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="tahun" type="date" placeholder="Type here" value="{{ old('tahun') }}"
                    ...
                    <div class="form-control w-full max-w-full">
                        ...
                        <input name="warna" type="text" placeholder="Type here" value="{{ old('warna') }}"
                            class="input-bordered input w-full max-w-full" />
                        <label class="label">
                            <span class="label-text-alt"></span>
                            <span class="label-text-alt text-red-600">
